...
<p align="center">
  ...
  <img src="https://img.shields.io/static/v1?style=for-the-badge&label=initial-commit&message=August Luplau Gliese&color=inactive"/>
...
# Description
[Examples](https://nqcp.github.io/NQCP-AA-git-Simulations/example_notebooks/index.html)
# Installation
...
If you have gotten 'qconqc' from source, you may run the tests locally.

Install `qconqc` along with its test dependencies into your virtual environment by executing the following in the root folder
...
If you have gotten `qconqc` from source, you may build the docs locally.

Install `qconqc` along with its documentation dependencies into your virtual environment by executing the following in the root folder
